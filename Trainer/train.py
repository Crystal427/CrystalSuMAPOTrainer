...
def main(args):
    ...
    # Use 8-bit optimizers for lower memory usage
    ...
    elif args.use_8bit_AdEMA:
        try:
            import bitsandbytes as bnb
        except ImportError:
            raise ImportError(
                "To use 8-bit AdEMAMix, please install the bitsandbytes library: `pip install bitsandbytes`."
            )
    ...
    # Create optimizer with appropriate parameters based on optimizer type
    if args.use_8bit_AdEMA:
